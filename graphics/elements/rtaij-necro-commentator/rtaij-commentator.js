(function () {
	...
	class RtaijCommentator extends Polymer.Element {
		static get is() {
			return 'rtaij-commentator';
		}
		...
		ready() {
			...
			currentRun.on('change', newVal => {
				...
				const medias = ['twitch', 'nico', 'twitter'].filter(media => this.commentator[media]);
	...
	customElements.define(RtaijCommentator.is, RtaijCommentator);
})();
